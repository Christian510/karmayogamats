    ...
    return (
        <div>
            <div className="home-container">
                <section className="hero" id="hero-image">
                    <div className="flex-center-col content-container">
                ...
                <section className="get-started flex-center-col">
                    ...
                    <div className="flex-center-row">
                        <div className="headings flex-center-col ">
                ...
                <section className="content content-bg-img">
                    <div className="flex-center-col content-container" >
                        <h1>How It Works</h1>
                        <div className="flex-center-row">
